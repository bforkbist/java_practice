...
class File_Handling{
    public static void main(final String[] args){
        ...
        try{
            ...
            myWrite.write("file in java might be hard but it can be ");;
            myWrite.close();
        ...
        try{
            // File myObj = new File("file.teaxt");
            // FileWriter myWrite = new FileWriter("filea.txt");
            FileWriter myWrite=new FileWriter("filea.txt", true);
            myWrite.append("\nfile in java might be hard but it can be done");
            myWrite.close();
            System.out.println("file written");
        } catch(IOException e){
            System.out.println("error occured");;
        ...
        // reading a file
        try{
            final FileReader myRead = new FileReader("filea.txt");
